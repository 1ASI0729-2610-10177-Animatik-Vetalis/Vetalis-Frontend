...
export class ClinicalService {
  ...
  loadAll() {
    return forkJoin({
      ...
      tiposVacuna:       this.http.get<any[]>(`${this.base}/tiposVacuna`),
      hospitalizaciones: this.http.get<any[]>(`${this.base}/hospitalizaciones`),
      citas:             this.http.get<any[]>(`${this.base}/citas`),
      veterinarios:      this.http.get<any[]>(`${this.base}/veterinarios`),
    }).pipe(
      map(d => {
        ...
        return {
          ...
          consultations:     ConsultationAssembler.toDomainList(d.consultas, d.mascotas, d.clientes, d.razas, d.veterinarios),
          vaccines:          VaccineAssembler.toDomainList(d.vacunas, d.mascotas, d.razas, d.tiposVacuna),
          hospitalizations:  HospitalizationAssembler.toDomainList(d.hospitalizaciones, d.mascotas, d.clientes, d.razas),
  ...
  createHospitalizacion(body: any)  { return this.http.post(`${this.base}/hospitalizaciones`, body); }
